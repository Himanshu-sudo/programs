...
In a cloud data center, the client requests are catered
...
managing the containers’ states. We observe that many cloud based application services are event-triggered, so they remain
